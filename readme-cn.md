...
|App (104)|Version|Persist|Tag|Description|
|:-:|:-:|:-:|:-:|-|
...
|[Clink](https://chrisant996.github.io/clink/)|<a href="./bucket/Clink.json"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FClink.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|`Link`||Bash 在 cmd.exe 中强大的命令行编辑功能。|
...
|[Fishing-Funds](https://ff.1zilc.top/)|<a href="./bucket/Fishing-Funds.json"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FFishing-Funds.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|`Link`||一款跨平台的基金股票行情监控工具。|
...
|[IPTVnator](https://github.com/4gray/iptvnator)|<a href="./bucket/IPTVnator.json"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FIPTVnator.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|`Link`||一个支持 IPTV 播放列表播放 (m3u、m3u8) 的视频播放器应用程序。|
...
|[Lapce](http://lapce.dev/)|<a href="./bucket/Lapce.json"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FLapce.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|✔️||用 Rust 编写的快速且强大的代码编辑器。|
...
|[Notepads](https://www.notepadsapp.com/)|<a href="./bucket/Notepads.json"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FNotepads.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|`Link`|`Msix`|一款设计简约的现代轻量级文本编辑器。|
...
|[powershell-yaml](https://github.com/cloudbase/powershell-yaml)|<a href="./bucket/powershell-yaml.json"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2Fpowershell-yaml.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|➖|`PSModule`|一个用于解析 YAML 的 PowerShell 模块。|
...
|[Seanime](https://seanime.rahim.app/)|<a href="./bucket/Seanime.json"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FSeanime.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|`Link`||免费开源的媒体服务器，为动漫爱好者提供丰富功能。|
...
|[Starship](https://starship.rs/)|<a href="./bucket/Starship.json"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FStarship.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|`Link`|`Admin`|适用于任何 shell 的极简、极快且可无限定制的提示符。|
...
|[TranslucentTB](https://github.com/TranslucentTB/TranslucentTB)|<a href="./bucket/TranslucentTB.json"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FTranslucentTB.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|`Link`|`Msix`|一个轻量级的实用程序，使 Windows 任务栏半透明/透明。|
...
|[v2rayN](https://github.com/2dust/v2rayN)|<a href="./bucket/v2rayN.json"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2Fv2rayN.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|✔️||一个适用于 Windows 的 V2Ray 客户端，支持 Xray & v2fly 核心。|
...
|[Vov-Sticky-Notes](https://vovsoft.com/software/vov-sticky-notes/)|<a href="./bucket/Vov-Sticky-Notes.json"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FVov-Sticky-Notes.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|✔️||创建数字贴纸和提醒事项。|
|[VSCode](https://code.visualstudio.com/)|<a href="./bucket/VSCode.json"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FVSCode.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|`Link`||一个轻量级、功能强大，插件生态丰富的文件编辑器。|
