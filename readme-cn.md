...
|App (127)|Version|Persist|Tag|Description|
|:-:|:-:|:-:|:-:|-|
|[aDrive](https://www.alipan.com/ "点击查看 aDrive 的主页或仓库")|<a href="./bucket/aDrive.json" title="点击查看 aDrive 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FaDrive.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="aDrive 使用 Link 进行数据持久化">Link</code>||阿里云盘，一款速度快、不打扰、够安全、易于分享的网盘。|
...
|[Argc-completions](https://github.com/sigoden/argc-completions "点击查看 Argc-completions 的主页或仓库")|<a href="./bucket/Argc-completions.json" title="点击查看 Argc-completions 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FArgc-completions.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="Argc-completions 未实现 persist，因为不存在数据或者没有实现的必要">➖</code>||适用于 1000 多个命令的 bash、zsh、fish、powershell、nushell 自动补全功能。|
|[Argc](https://github.com/sigoden/argc "点击查看 Argc 的主页或仓库")|<a href="./bucket/Argc.json" title="点击查看 Argc 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FArgc.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="Argc 未实现 persist，因为不存在数据或者没有实现的必要">➖</code>||一个 Bash CLI 框架，也是 Bash Command Runner。|
...
|[CapCut](https://www.capcut.com/ "点击查看 CapCut 的主页或仓库")|<a href="./bucket/CapCut.json" title="点击查看 CapCut 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FCapCut.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="CapCut 使用 Link 进行数据持久化">Link</code>|<code title="在卸载时可能需要用户交互">NoSilentUninstall</code>|字节跳动的一款多合一在线视频编辑软件(剪映专业版的国际版本)，具有逐帧轨道编辑器和云存储等，让创作、上传和分享更加容易。|
...
|[CPU-Z](https://www.cpuid.com/softwares/cpu-z.html "点击查看 CPU-Z 的主页或仓库")|<a href="./bucket/CPU-Z.json" title="点击查看 CPU-Z 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FCPU-Z.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="CPU-Z 使用 Scoop 官方的 persist 实现">✔️</code>||系统信息软件。|
...
|[Dida](https://www.dida365.com/ "点击查看 Dida 的主页或仓库")|<a href="./bucket/Dida.json" title="点击查看 Dida 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FDida.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="Dida 使用 Link 进行数据持久化">Link</code>||滴答清单，一款轻便的待办事项 (Todo)、日程管理 (GTD) 应用。|
|[DingTalk](https://www.dingtalk.com/ "点击查看 DingTalk 的主页或仓库")|<a href="./bucket/DingTalk.json" title="点击查看 DingTalk 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FDingTalk.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="DingTalk 使用 Link 进行数据持久化">Link</code>|<code title="在安装、更新或卸载时需要管理员权限">RequireAdmin</code>|钉钉，阿里巴巴的智能移动办公平台。|
|[DouBao](https://www.doubao.com/ "点击查看 DouBao 的主页或仓库")|<a href="./bucket/DouBao.json" title="点击查看 DouBao 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FDouBao.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="DouBao 使用 Link 进行数据持久化">Link</code>|<code title="在卸载时可能需要用户交互">NoSilentUninstall</code>|豆包，字节跳动的 AI 聊天智能对话问答助手，写作文案翻译情感陪伴编程全能工具。|
|[DouYin](https://www.douyin.com/ "点击查看 DouYin 的主页或仓库")|<a href="./bucket/DouYin.json" title="点击查看 DouYin 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FDouYin.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="DouYin 使用 Link 进行数据持久化">Link</code>|<code title="在安装、更新或卸载时需要管理员权限">RequireAdmin</code>|抖音，字节跳动的一个短视频平台。|
...
|[FeiShu](https://www.feishu.cn/ "点击查看 FeiShu 的主页或仓库")|<a href="./bucket/FeiShu.json" title="点击查看 FeiShu 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FFeiShu.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="FeiShu 使用 Link 进行数据持久化">Link</code>|<code title="在卸载时可能需要用户交互">NoSilentUninstall</code>|飞书，字节跳动下先进企业协作与管理平台。|
...
|[Free-Download-Manager](https://www.freedownloadmanager.org "点击查看 Free-Download-Manager 的主页或仓库")|<a href="./bucket/Free-Download-Manager.json" title="点击查看 Free-Download-Manager 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FFree-Download-Manager.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="Free-Download-Manager 使用 Link 进行数据持久化">Link</code>||一个强大的下载管理器。|
...
|[Gpg4win](https://www.gpg4win.org "点击查看 Gpg4win 的主页或仓库")|<a href="./bucket/Gpg4win.json" title="点击查看 Gpg4win 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FGpg4win.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="Gpg4win 使用 Link 进行数据持久化">Link</code>|<code title="在安装、更新或卸载时需要管理员权限">RequireAdmin</code>|GNU Privacy Guard 是一款用于文件和电子邮件的加密软件，适用于 Windows 系统。|
...
|[HWiNFO](https://www.hwinfo.com "点击查看 HWiNFO 的主页或仓库")|<a href="./bucket/HWiNFO.json" title="点击查看 HWiNFO 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FHWiNFO.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="HWiNFO 使用 Scoop 官方的 persist 实现">✔️</code>||适用于 Windows 和 DOS 的全面硬件分析、监测与报告。|
...
|[InputTip-zip](https://inputtip.abgox.com "点击查看 InputTip-zip 的主页或仓库")|<a href="./bucket/InputTip-zip.json" title="点击查看 InputTip-zip 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FInputTip-zip.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="InputTip-zip 使用 Scoop 官方的 persist 实现">✔️</code>||(zip 版本) 一个输入法状态管理工具：实时提示(鼠标样式、符号显示) + 窗口自动切换状态 + 快捷键切换状态。|
|[InputTip](https://inputtip.abgox.com/ "点击查看 InputTip 的主页或仓库")|<a href="./bucket/InputTip.json" title="点击查看 InputTip 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FInputTip.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="InputTip 使用 Scoop 官方的 persist 实现">✔️</code>||(exe 版本) 一个输入法状态管理工具：实时提示(鼠标样式、符号显示) + 窗口自动切换状态 + 快捷键切换状态。|
...
|[JianyingPro](https://www.capcut.cn/ "点击查看 JianyingPro 的主页或仓库")|<a href="./bucket/JianyingPro.json" title="点击查看 JianyingPro 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FJianyingPro.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="JianyingPro 使用 Link 进行数据持久化">Link</code>|<code title="在卸载时可能需要用户交互">NoSilentUninstall</code>|剪映专业版，一款全能易用的桌面端剪辑软件，让创作更简单。|
...
|[Lark](https://www.larksuite.com/ "点击查看 Lark 的主页或仓库")|<a href="./bucket/Lark.json" title="点击查看 Lark 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FLark.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="Lark 使用 Link 进行数据持久化">Link</code>|<code title="在卸载时可能需要用户交互">NoSilentUninstall</code>|字节跳动下先进企业协作与管理平台(飞书的国际版本)。|
...
|[Oh-My-Posh](https://ohmyposh.dev "点击查看 Oh-My-Posh 的主页或仓库")|<a href="./bucket/Oh-My-Posh.json" title="点击查看 Oh-My-Posh 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FOh-My-Posh.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="Oh-My-Posh 未实现 persist，因为不存在数据或者没有实现的必要">➖</code>||适用于任何 shell 的提示主题引擎。|
|[Onlook](https://onlook.com/ "点击查看 Onlook 的主页或仓库")|<a href="./bucket/Onlook.json" title="点击查看 Onlook 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FOnlook.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="Onlook 使用 Link 进行数据持久化">Link</code>||一款开源的带有视觉氛围的代码编辑器，借助人工智能以可视化方式构建、设计样式并编辑你的应用程序。|
...
|[QQ](https://im.qq.com/ "点击查看 QQ 的主页或仓库")|<a href="./bucket/QQ.json" title="点击查看 QQ 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FQQ.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="QQ 使用 Link 进行数据持久化">Link</code>|<code title="在安装、更新或卸载时需要管理员权限">RequireAdmin</code> <code title="在卸载时可能需要用户交互">NoSilentUninstall</code>|(NT 版本) QQ，腾讯的一款聊天通讯工具。|
...
|[Simple-Mind-Map](https://github.com/wanglin2/mind-map "点击查看 Simple-Mind-Map 的主页或仓库")|<a href="./bucket/Simple-Mind-Map.json" title="点击查看 Simple-Mind-Map 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FSimple-Mind-Map.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="Simple-Mind-Map 使用 Link 进行数据持久化">Link</code>||一个还算强大的Web思维导图。|
...
|[SodaMusic](https://music.douyin.com/ "点击查看 SodaMusic 的主页或仓库")|<a href="./bucket/SodaMusic.json" title="点击查看 SodaMusic 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FSodaMusic.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="SodaMusic 使用 Link 进行数据持久化">Link</code>||汽水音乐，字节跳动的音乐平台。|
...
|[WeChat](https://www.wechat.com/ "点击查看 WeChat 的主页或仓库")|<a href="./bucket/WeChat.json" title="点击查看 WeChat 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FWeChat.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="WeChat 使用 Link 进行数据持久化">Link</code>|<code title="在安装、更新或卸载时需要管理员权限">RequireAdmin</code> <code title="在卸载时可能需要用户交互">NoSilentUninstall</code>|微信，腾讯的一款聊天通讯工具。|
...
|[YuQue](https://www.yuque.com/ "点击查看 YuQue 的主页或仓库")|<a href="./bucket/YuQue.json" title="点击查看 YuQue 的 manifest json 文件"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fabgox%2Fabyss%2Frefs%2Fheads%2Fmain%2Fbucket%2FYuQue.json&query=%24.version&prefix=v&label=%20" alt="version" /></a>|<code title="YuQue 使用 Link 进行数据持久化">Link</code>||语雀，阿里巴巴的笔记与文档知识库。|
